...
*/
	...
	$sql = "select l.location_id, l.display_value, group_concat(c.display_value SEPARATOR ', ') as categories from location l left join location_category lc on l.location_id = lc.location_id left join category c on lc.category_id = c.category_id and c.active = 1 where l.active = 1 group by l.location_id, l.display_value order by l.display_value";
	...
	if (!$stmt->bind_result($locationId, $locationDisplay, $categories)){
